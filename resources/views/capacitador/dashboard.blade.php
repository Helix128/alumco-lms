...
@section('content')
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-10">
        <div class="bg-white p-6 rounded-[24px] shadow-sm border border-gray-100 flex items-center gap-5 transition-all hover:shadow-md">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-10">
        {{-- Chart --}}
        <div class="lg:col-span-7 bg-white p-8 rounded-[32px] shadow-sm border border-gray-100">
        ...
        {{-- Últimos cursos --}}
        <div class="lg:col-span-5 bg-white p-8 rounded-[32px] shadow-sm border border-gray-100 flex flex-col">
