            ...
            <table class="w-full text-left border-collapse">
                <thead>
                    <tr class="bg-gray-50/50">
                        <th class="px-8 py-5 text-[11px] font-display font-bold uppercase tracking-widest text-gray-400 border-b border-gray-100">Nombre</th>
                        <th class="px-8 py-5 text-[11px] font-display font-bold uppercase tracking-widest text-gray-400 border-b border-gray-100 hidden sm:table-cell">Estamento</th>
                        <th class="px-8 py-5 text-[11px] font-display font-bold uppercase tracking-widest text-gray-400 border-b border-gray-100 hidden md:table-cell">Sede</th>
                        <th class="px-8 py-5 text-[11px] font-display font-bold uppercase tracking-widest text-gray-400 border-b border-gray-100">Progreso</th>
                        <th class="px-8 py-5 text-[11px] font-display font-bold uppercase tracking-widest text-gray-400 border-b border-gray-100 text-right">Certificado</th>
                    </tr>
                </thead>
                        ...
                        <tr class="hover:bg-Alumco-cream/30 transition-colors group">
                            <td class="px-8 py-5">
                                <div class="flex items-center gap-4">
                                    ...
                                    <div>
                                        <p class="font-display font-bold text-Alumco-gray leading-tight">{{ $usuario->name }}</p>
                                        <p class="text-xs text-Alumco-gray/50 mt-1">{{ $usuario->email }}</p>
                                    </div>
                                </div>
                            </td>
                            <td class="px-8 py-5 text-sm font-bold text-Alumco-gray hidden sm:table-cell">
                                {{ $usuario->estamento?->nombre ?? '—' }}
                            </td>
                            <td class="px-8 py-5 text-sm text-Alumco-gray/60 hidden md:table-cell uppercase tracking-tighter">
                                {{ $usuario->sede?->nombre ?? '—' }}
                            </td>
                            <td class="px-8 py-5">
