<div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
    ...
    <div class="space-y-6">
        ...
        <div class="pt-6 border-t border-gray-50 space-y-4">
            <h4 class="text-sm font-black text-Alumco-blue/40 uppercase tracking-widest">Acreditación Institucional</h4>
            
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                <div class="space-y-4">
                    <label class="block text-sm font-bold text-Alumco-gray">Firma del Representante Legal</label>
                    
                    <div class="relative group">
                        <input type="file" wire:model="firma_rep_legal" accept="image/*"
                ...
                <div class="bg-gray-50 rounded-2xl p-6 border border-gray-100 flex flex-col items-center justify-center">
                    ...
                    @if ($firma_actual)
                        <img src="{{ asset('storage/' . $firma_actual) }}" class="h-24 object-contain mix-blend-multiply">
                    @else
