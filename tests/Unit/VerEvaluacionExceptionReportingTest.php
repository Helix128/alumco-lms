...
{
    public function test_certificate_generation_exception_is_reported_by_the_central_service(): void
    {
        $source = file_get_contents(dirname(__DIR__, 2).'/app/Services/CertificadoService.php');
