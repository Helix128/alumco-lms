...
{
    public function __construct(private readonly EditHistoryService $history) {}
    ...
    public function update(UpdateSeccionCursoRequest $request, Curso $curso, SeccionCurso $seccion): RedirectResponse
    {
        ...
        $this->history->captureChange(
            ...
            $curso->id,
            'Renombrar sección',
            fn () => $seccion->update($request->validated()),
        );
    ...
    public function reordenar(ReorderSeccionesRequest $request, Curso $curso)
    {
        ...
        $this->history->captureChange(
            ...
            function () use ($estructura, $curso): void {
